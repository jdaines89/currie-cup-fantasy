...
|---|---|---|---|
| raw | `raw.feed_payloads` | Every feed response, verbatim, append-only, deduplicated by hash | Ingest job |
...
auth schema, and runs 22 behaviour checks: access for strangers, members and
